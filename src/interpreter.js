import { parse } from "./parser.js?v=1564DFB5-4ABB-4868-B1A0-440C25F2DE25";
import {
  BUILT_INS,
  STD_LIB,
} from "./core.js?v=1564DFB5-4ABB-4868-B1A0-440C25F2DE25";
import { panic } from "./utils.js?v=1564DFB5-4ABB-4868-B1A0-440C25F2DE25";
